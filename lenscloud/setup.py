...
def seed_sidebar():
    ...
    groups = [
        ...
        ("Operations", [("Test Runs", "/lenscloud/platform/environment-test-runs"), ("Orchestration Logs", "/lenscloud/platform/orchestration-logs"), ("Support", "/lenscloud/platform/support-tickets")], True),
