...
export const platformResources = [
	...
	},
	{
		...
		label: 'Capability',
		doctype: 'Capability',
		route: '/platform/capability',
		detailRoute: (name) => `/platform/capability/${encodeURIComponent(name)}`,
		icon: Store,
		listHelp: 'Marketplace capability catalogue shown to customers, including pricing, prerequisites, and portal visibility controls.',
		creatable: true,
		editable: true,
		lifecycleFields: [
			{ key: 'capability_name', label: 'Capability Name', required: true },
			{ key: 'capability_code', label: 'Capability Code', required: true },
			{ key: 'status', label: 'Status', default: 'Active', ...selectField(['Available', 'Planning', 'Coming Soon', 'Beta', 'Retired']) },
			{ key: 'enabled', label: 'Enabled', ...checkField },
			{ key: 'short_description', label: 'Short Description', type: 'textarea' },
			{ key: 'long_description', label: 'Long Description', type: 'textarea' },
			{ key: 'icon', label: 'Icon / Banner Image', type: 'file' },
			{ key: 'category', label: 'Category', ...linkField('Category', ['title']) },
			{ key: 'sort_order', label: 'Sort Order', type: 'number' },
			{
				key: 'prerequisites',
				label: 'Prerequisite Capabilities',
				type: 'table',
				description: 'Other capabilities that must already be opted-in before this one can be enabled.',
				columns: [
					{ key: 'capability', label: 'Capability', required: true, ...linkField('Capability', ['capability_name', 'capability_code']) },
				],
			},
			{ key: 'pricing_model', label: 'Pricing Model', ...linkField('Pricing Model', ['title']) },
			{ key: 'monthly_price', label: 'Price' },
			{ key: 'billing_frequency', label: 'Billing Frequency', default: 'Monthly', ...selectField(['Monthly', 'Quarterly', 'Yearly', 'One Time']) },
			{ key: 'docs_link', label: 'Learn More Link' },
			...
			{ key: 'experimental', label: 'Experimental', ...checkField },
		],
		summaryFields: [
			{ key: 'capability_name', label: 'Capability Name' },
			{ key: 'capability_code', label: 'Code' },
			{ key: 'category', label: 'Category', ...linkField('Category', ['title']) },
			{ key: 'status', label: 'Status', ...selectField(['Available', 'Planning', 'Coming Soon', 'Beta', 'Retired']) },
			{ key: 'enabled', label: 'Enabled' },
			{ key: 'publish_in_customer_portal', label: 'Published' },
		],
		detailFields: [
			...
			{ key: 'icon', label: 'Icon / Banner Image' },
			{ key: 'category', label: 'Category', ...linkField('Category', ['title']) },
			{ key: 'sort_order', label: 'Sort Order' },
			{
				...
				type: 'table',
				columns: [
					{ key: 'capability', label: 'Capability', ...linkField('Capability', ['capability_name', 'capability_code']) },
				],
			},
			{ key: 'pricing_model', label: 'Pricing Model', ...linkField('Pricing Model', ['title']) },
			{ key: 'monthly_price', label: 'Price' },
			...
			{ key: 'docs_link', label: 'Learn More Link' },
			{ key: 'publish_in_customer_portal', label: 'Publish in Customer Portal' },
			{ key: 'allow_self_service', label: 'Allow Self Service' },
			{ key: 'request_access_only', label: 'Request Access Only' },
			{ key: 'experimental', label: 'Experimental' },
		],
		actions: [],
	},
	{
		key: 'capability-opted',
		scope: 'platform',
		label: 'Capability Opted',
		doctype: 'Capability Opted',
		route: '/platform/capability-opted',
		detailRoute: (name) => `/platform/capability-opted/${encodeURIComponent(name)}`,
		icon: ListChecks,
		listHelp: 'Customer opt-in records for marketplace capabilities. Created by the customer portal toggle; opting out flips Opted In to 0 rather than deleting the record.',
		creatable: false,
		editable: true,
		summaryFields: [
			{ key: 'customer', label: 'Customer', ...linkField('Customer', ['first_name', 'last_name']) },
			...
			{ key: 'opted_on', label: 'Opted On' },
		],
		detailFields: [
			{ key: 'name', label: 'Record ID' },
			{ key: 'customer', label: 'Customer', linkPrefix: '/platform/customers/', ...linkField('Customer', ['first_name', 'last_name']) },
			{ key: 'capability', label: 'Capability', linkPrefix: '/platform/capability/', ...linkField('Capability', ['capability_name', 'capability_code']) },
			{ key: 'opted_in', label: 'Opted In', ...checkField },
			{ key: 'opted_on', label: 'Opted On', type: 'datetime' },
			{ key: 'opted_out_on', label: 'Opted Out On', type: 'datetime' },
			{ key: 'opted_by', label: 'Opted By', ...linkField('User', ['full_name', 'email']) },
		],
		actions: [],
	},
...
export const customerNav = [
	{
		...
		items: [
			...
			{ key: 'customer-marketplace', label: 'Marketplace', note: 'Capability Marketplace', route: '/customer/marketplace', icon: Store },
