...
1. AGENTS.md
2. requirements.md
3. docs/handoffs/platform/agent-handoff.md
4. docs/platform-workitems.md
5. docs/architecture/platform-runtime-lifecycle.md
6. docs/architecture/release-model.md
7. docs/architecture/database-server-model.md
8. docs/architecture/wildcard-domain-model.md
9. docs/architecture/state-model.md
10. docs/architecture/workflows.md
...
- lifecycle actions already defined in `docs/architecture/platform-runtime-lifecycle.md`.
