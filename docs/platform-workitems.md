...
| Remaining Bench Command runner families handoff | After real Bench/Site runner proof, Infra enables backup create, restore, Bench Test trigger, and LATP runner contracts; Platform keeps those commands Unsupported until each runner contract is live and then wires them into Site Control policy | In Progress | 2026-06-29 |  |
