...
| Release Group bootstrap app install contract | Release Group included apps use a child table with install-at-site-creation and install-sequence flags; Platform derives bootstrap app payloads from the Site Bench Release Group, excludes frappe, and runs Infra app-aware Site bootstrap jobs with the Release Group runtime digest; live Free Plan retest now depends on cluster-runner config and asset readiness incidents `LC-E2E-20260719-001` / `LC-E2E-20260719-002` | In Progress | 2026-07-09 |  |
| Site bootstrap app install incident | Customer Free Plan Site `tharahub.cloud.lmnaslens.com` reached runtime/HTTPS Ready; Platform fixed app install idempotency and confirmed bootstrap uses Release runtime digest. Remaining E2E completion is tracked by runner digest and asset readiness incidents. | In Progress | 2026-07-17 |  |
