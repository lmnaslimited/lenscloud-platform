...
| CUA Site bootstrap and SSO automation | Platform becomes the OAuth/CUA authority for provisioned Sites: setup wizard completion, OAuth/social login configuration, first-user/member sync, Site Access Grants, Open Site without password, revocation, and audit are driven through a Kubernetes API Bench Execute runner contract | Pending | 2026-07-03 |  |
