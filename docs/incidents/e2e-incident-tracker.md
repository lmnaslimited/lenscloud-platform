...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| LC-E2E-20260707-002 | 2026-07-07 | CUA OAuth configure live verification | High | INF-022 `oauth.configure` runner execution | Infra / Platform | Open | Dedicated Platform `configure_site_oauth` reached the runner as `ORCH-2026-00226`, used the short-lived Secret mount, and cleaned Job/ConfigMap/Pod/Secret, but the runner returned sanitized `RUNNER_FAILED`; final `oauth.status` `ORCH-2026-00227` still shows `Social login: Missing`. | `docs/evidence/customer-launch/cua-oauth-runner-20260707.md` | `docs/handoffs/infra/cua-oauth-configure-runner-failed-20260707.md` | Ask Infra to verify the runner-side failure cause without exposing Secrets or pod logs to Platform, then hand back a fixed contract or required Platform request adjustment. | Pending |
